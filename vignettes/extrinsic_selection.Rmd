...
learners <- c("SL.glm", "SL.ranger.imp", "SL.xgboost")
V <- 2
...
To properly handle the missing data, we first perform multiple imputation. We use the `R` package `mice`, here with only 5 imputations (in practice, more imputations may be better).
...
```{r extrinsic-selection-with-missing-data}
set.seed(20231121)
